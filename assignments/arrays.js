...
let lastCar = 0;
console.log('The make of the last car is ' + (inventory[inventory.length-1].car_make) + '.' + ' The model of the last car is ' + (inventory[inventory.length -1].car_model) + '.');
...
console.log(carModels);
  ...
  //   }
  // }
  // console.log(carModels); --> Reed's solution
